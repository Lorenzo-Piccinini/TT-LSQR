...
% 
% 
%     [~, ind] = min([condest(R1{i}), condest(R2{i}), condest(R3{i})]); %,cond(R4{i})]);
%     %[~, ind] = min([condest(R1{i})*condest(L1{i}), condest(R2{i})*condest(L2{i}), condest(R3{i})*condest(L3{i})]); %,cond(R4{i})]);
