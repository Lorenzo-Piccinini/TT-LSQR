...
addpath('/home/valeria/matlab/tensor_toolbox-v3.6')
...
%values{4} = values4;
for i = 1:3
    %[~, R1{i}] = qr(values1{i},0); [~, R2{i}] = qr(values2{i},0); [~, R3{i}] = qr(values3{i},0); [~, R4{i}] = qr(values4{i},0);
    [L1{i}, R1{i}] = lu(values1{i}); [L2{i}, R2{i}] = lu(values2{i}); [L3{i}, R3{i}] = lu(values3{i}); [L4{i}, R4{i}] = lu(values4{i});
